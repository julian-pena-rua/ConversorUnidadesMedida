Public Class Volumen
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If ComboBox1.SelectedIndex = 0 And ComboBox2.SelectedIndex = 1 Then
            Label3.Text = NumericUpDown1.Value * 1000000000
        End If
        If ComboBox1.SelectedIndex = 0 And ComboBox2.SelectedIndex = 2 Then
            Label3.Text = NumericUpDown1.Value * 100000000000
        End If
        If ComboBox1.SelectedIndex = 0 And ComboBox2.SelectedIndex = 3 Then
            Label3.Text = NumericUpDown1.Value * 10000000000
        End If
        ...
        If ComboBox1.SelectedIndex = 0 And ComboBox2.SelectedIndex = 5 Then
            Label3.Text = NumericUpDown1.Value * 10000000000000
        End If
        If ComboBox1.SelectedIndex = 0 And ComboBox2.SelectedIndex = 6 Then
            Label3.Text = NumericUpDown1.Value * 10000000000000
        End If
        If ComboBox1.SelectedIndex = 0 And ComboBox2.SelectedIndex = 7 Then
            Label3.Text = NumericUpDown1.Value * 10000000000000000
        End If
        ...
        If ComboBox1.SelectedIndex = 1 And ComboBox2.SelectedIndex = 6 Then
            Label3.Text = NumericUpDown1.Value * 1000000
        End If
        If ComboBox1.SelectedIndex = 1 And ComboBox2.SelectedIndex = 7 Then
            Label3.Text = NumericUpDown1.Value * 1000000000
        End If
        ...
        If ComboBox1.SelectedIndex = 2 And ComboBox2.SelectedIndex = 6 Then
            Label3.Text = NumericUpDown1.Value * 10000
        End If
        If ComboBox1.SelectedIndex = 2 And ComboBox2.SelectedIndex = 7 Then
            Label3.Text = NumericUpDown1.Value * 10000000
        End If
        If ComboBox1.SelectedIndex = 3 And ComboBox2.SelectedIndex = 0 Then
            Label3.Text = NumericUpDown1.Value / 1000000000000
        End If
        ...
        If ComboBox1.SelectedIndex = 3 And ComboBox2.SelectedIndex = 6 Then
            Label3.Text = NumericUpDown1.Value * 1000
        End If
        If ComboBox1.SelectedIndex = 3 And ComboBox2.SelectedIndex = 7 Then
            Label3.Text = NumericUpDown1.Value * 1000000
        End If
        ...
        If ComboBox1.SelectedIndex = 4 And ComboBox2.SelectedIndex = 6 Then
            Label3.Text = NumericUpDown1.Value * 1000
        End If
        If ComboBox1.SelectedIndex = 4 And ComboBox2.SelectedIndex = 7 Then
            Label3.Text = NumericUpDown1.Value * 1000000
        End If
        If ComboBox1.SelectedIndex = 5 And ComboBox2.SelectedIndex = 0 Then
            Label3.Text = NumericUpDown1.Value / 1000000000000000
        End If
        ...
        If ComboBox1.SelectedIndex = 5 And ComboBox2.SelectedIndex = 6 Then
            Label3.Text = NumericUpDown1.Value
        End If
        If ComboBox1.SelectedIndex = 5 And ComboBox2.SelectedIndex = 7 Then
            Label3.Text = NumericUpDown1.Value * 1000
        End If
        ...
        If ComboBox1.SelectedIndex = 6 And ComboBox2.SelectedIndex = 6 Then
            Label3.Text = NumericUpDown1.Value
        End If
        If ComboBox1.SelectedIndex = 6 And ComboBox2.SelectedIndex = 7 Then
            Label3.Text = NumericUpDown1.Value * 1000
        End If
        If ComboBox1.SelectedIndex = 7 And ComboBox2.SelectedIndex = 0 Then
            Label3.Text = NumericUpDown1.Value / 1000000000000000000
        End If
        If ComboBox1.SelectedIndex = 7 And ComboBox2.SelectedIndex = 1 Then
            Label3.Text = NumericUpDown1.Value / 1000000000
        End If
        If ComboBox1.SelectedIndex = 7 And ComboBox2.SelectedIndex = 2 Then
            Label3.Text = NumericUpDown1.Value / 10000000
        End If
        If ComboBox1.SelectedIndex = 7 And ComboBox2.SelectedIndex = 3 Then
            Label3.Text = NumericUpDown1.Value / 1000000
        End If
        If ComboBox1.SelectedIndex = 7 And ComboBox2.SelectedIndex = 4 Then
            Label3.Text = NumericUpDown1.Value / 1000000
        End If
        If ComboBox1.SelectedIndex = 7 And ComboBox2.SelectedIndex = 5 Then
            Label3.Text = NumericUpDown1.Value / 1000
        End If
        If ComboBox1.SelectedIndex = 7 And ComboBox2.SelectedIndex = 6 Then
            Label3.Text = NumericUpDown1.Value / 1000
        End If
        If ComboBox1.SelectedIndex = 7 And ComboBox2.SelectedIndex = 7 Then
            Label3.Text = NumericUpDown1.Value
        End If
    End Sub
